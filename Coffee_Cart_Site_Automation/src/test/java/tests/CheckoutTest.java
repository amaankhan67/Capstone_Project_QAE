...
public class CheckoutTest {
    ...
    @Test(priority=1, description = "Verify that the checkout form is displayed and ready")
    ...
    @Test(priority=2, description = "Verify successful payment submission with valid Name and Email")
    ...
    @Test(priority=3, description = "Verify payment failure when Name field is empty")
    ...
    @Test(priority=4, description = "Verify payment failure with invalid Email format")
    ...
    @Test(priority=5, description = "Verify payment failure when Email field is empty")
    ...
    @Test(priority=6, description = "Verify payment failure when both Name and Email fields are empty")
